...
# cek connection and vpn wire-guard
alias cekIp="curl zx2c4.com/ip"
alias wireOff="sudo wg-quick down wgcf-profile"
alias wireOn="sudo wg-quick up wgcf-profile"
